...
A análise dos trabalhos relacionados e do estado da prática revela uma lacuna significativa: enquanto há sistemas acadêmicos robustos para gestão geral, falta uma solução que trate as particularidades da monitoria. O Sistema de Monitoria-IC distingue-se por cinco dimensões principais. Primeiro, é \textbf{específico para o workflow de monitoria}, ao contrário de sistemas genéricos que tentam adaptar módulos gerais para diferentes processos acadêmicos. Segundo, \textbf{cobre o ciclo de vida completo}, desde a criação de projetos pelos professores até a emissão de certificados finais, eliminando a fragmentação observada nos sistemas analisados. Terceiro, \textbf{automatiza etapas críticas} via integrações com armazenamento de arquivos, geração de PDFs, assinaturas digitais e notificações, reduzindo drasticamente trabalho manual. Quarto, adota um \textbf{stack tecnológico moderno} (Next.js 15, tRPC v11, PostgreSQL, MinIO) com foco em experiência do usuário, type-safety e desempenho, contrastando com sistemas legados observados em outras instituições. Quinto, e fundamental, \textbf{garante transparência e rastreabilidade} através de histórico auditável de todas as operações e acesso diferenciado por papéis (admin, professor, aluno, chefe de departamento), atendendo requisitos de governança institucional.
...
\begin{figure}[p]
  \centering
  \IfFileExists{images/monitoria/architecture-new.png}{\includegraphics[width=0.75\textwidth,keepaspectratio]{images/monitoria/architecture-new.png}}{\fbox{\parbox{0.95\linewidth}{architecture-new.png}}}
...
\begin{figure}[p]
  \centering
\IfFileExists{images/monitoria/data-model-new.png}{\includegraphics[width=0.85\textwidth,keepaspectratio]{images/monitoria/data-model-new.png}}{\fbox{\parbox{0.95\linewidth}{data-model-new.png}}}
...
\begin{figure}[H]
  \centering
\IfFileExists{images/monitoria/process-flow.png}{\includegraphics[width=0.6\linewidth,keepaspectratio]{images/monitoria/process-flow.png}}{\fbox{\parbox{0.95\linewidth}{process-flow.png}}}
