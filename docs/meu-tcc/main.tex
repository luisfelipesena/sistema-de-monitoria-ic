...
\begin{table*}[t]
  ...
  \begin{tblr}{
    ...
    Eliminar trabalhos manuais repetitivos & \ding{51} Validado & Templates reutilizáveis avaliados como excelentes para economia de tempo em semestres futuros; redução estimada de 80\% em tarefas repetitivas \\
