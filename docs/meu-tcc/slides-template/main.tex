...
\begin{frame}{Interface do Sistema -- Administrador}
    \begin{columns}[T]
        \begin{column}{0.48\textwidth}
            ...
            \includegraphics[width=\linewidth,height=0.55\textheight,keepaspectratio]{admin-dashboard.png}
        \end{column}
        \begin{column}{0.48\textwidth}
            \centering
...
\begin{frame}{Interface do Sistema -- Professor e Estudante}
    \begin{columns}[T]
        \begin{column}{0.48\textwidth}
            ...
            \includegraphics[width=\linewidth,height=0.55\textheight,keepaspectratio]{professor-assinatura-documentos.png}
        \end{column}
        \begin{column}{0.48\textwidth}
            \centering
