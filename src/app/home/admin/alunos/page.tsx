...
export default function AlunosPage() {
  ...
  const { data: cursosData } = api.course.getCourses.useQuery({ includeStats: false })
  ...
  const alunos: Aluno[] = usersData?.users
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <div className="text-center">
          <Badge variant={row.original.bolsasAtivas > 0 ? 'default' : 'outline'}>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm">
                        {format(new Date(selectedAluno.criadoEm), 'dd/MM/yyyy \'às\' HH:mm')}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm">{selectedAluno.documentosValidados}/{selectedAluno.totalDocumentos}</p>
                    </div>
                  </div>
                </div>
              </div>
