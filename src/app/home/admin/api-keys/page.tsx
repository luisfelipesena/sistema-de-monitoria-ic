...
export default function ApiKeysPage() {
  ...
  const { data: apiKeys, refetch } = api.apiKey.listAll.useQuery()
  ...
  return (
    <div className="container mx-auto p-6">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-3xl font-bold">Gerenciamento de API Keys</h1>
          <p className="text-gray-600 mt-2">
            Gerencie chaves de API para integração programática com o sistema
          </p>
        </div>
            ...
            {generatedKey ? (
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input
                    id="keyName"
                    placeholder="Ex: API Cliente Mobile"
                    value={newKeyName}
            ...
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                <div>
                  ...
                  <p className="text-gray-400 text-xs">{apiKey.user.email}</p>
                </div>
