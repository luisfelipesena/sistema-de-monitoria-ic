...
export default function ManageProjectsPage() {
  ...
  return (
    <PagesLayout title="Gerenciar Projetos" subtitle="Administração de projetos de monitoria" actions={dashboardActions}>
      {loadingProjetos ? (
      ...
      <Dialog open={showPreviewDialog} onOpenChange={setShowPreviewDialog}>
        <DialogContent className="max-w-4xl">
          <DialogHeader>
            ...
            <DialogDescription>
              {selectedProject && (
                `Projeto: ${selectedProject.titulo} - ${selectedProject.professorResponsavelNome}`
              )}
            </DialogDescription>
          </DialogHeader>
