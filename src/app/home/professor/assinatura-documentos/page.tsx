...
function DocumentSigningContent() {
  ...
  if (selectedProjectId && templateData) {
    return (
      <PagesLayout
        title="Assinatura de Projeto - Professor"
            ...
            {pendingSignatureProjetos.length === 0 ? (
              <div className="text-center py-12 text-muted-foreground">
                ...
                <p>
                  ...
                  em rascunho aguardando sua assinatura.
                </p>
              </div>
            ) : (
              <Table>
      ...
      <Card className="mt-6">
        ...
        <CardContent className="space-y-2 text-sm text-muted-foreground">
          ...
          <div className="flex items-start gap-2">
            ...
            <p>
              O documento será automaticamente assinado e submetido para análise do administrador
            </p>
          </div>
        </CardContent>
      </Card>
