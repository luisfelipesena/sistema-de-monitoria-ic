...
export default function ProfessorProjetosPage() {
  ...
  const getActionButtons = (projeto: Projeto) => {
    const buttons = []
    ...
    if (projeto.status === 'DRAFT') {
      buttons.push(
        <Button
          ...
          asChild
        >
          <Link href={`/home/professor/projetos/${projeto.id}/editar`}>
    ...
    // Sign button - for projects needing professor signature
    if (projeto.status === 'DRAFT' && !projeto.assinaturaProfessor) {
      buttons.push(
        <Button
          key="sign"
          variant="default"
  ...
  const columns: ColumnDef<Projeto>[] = [
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <div className="text-center">
          <Badge variant={row.original.inscricoes > 0 ? 'default' : 'outline'}>
            {row.original.inscricoes}
          </Badge>
        </div>
      ),
    },
  ...
  return (
    <PagesLayout 
      title="Meus Projetos de Monitoria" 
        ...
        <Dialog open={isDetailDialogOpen} onOpenChange={setIsDetailDialogOpen}>
          <DialogContent className="sm:max-w-[800px]">
            <DialogHeader>
              ...
              <DialogDescription>
                Informações completas do projeto de monitoria
              </DialogDescription>
            </DialogHeader>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm">{selectedProjeto.bolsasAlocadas}/{selectedProjeto.bolsasSolicitadas}</p>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className="text-sm">
                        {format(new Date(selectedProjeto.criadoEm), 'dd/MM/yyyy \'às\' HH:mm')}
                      </p>
                    </div>
