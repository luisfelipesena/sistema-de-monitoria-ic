...
export function FileUploadField({
  ...
  const getStateColor = () => {
    switch (uploadState) {
      case 'success': return 'text-green-600 border-green-300 bg-green-50'
      case 'error': return 'text-red-600 border-red-300 bg-red-50'
      case 'uploading': return 'text-blue-600 border-blue-300 bg-blue-50'
      default: return isDragging ? 'text-blue-600 border-blue-400 bg-blue-50' : 'text-gray-600 border-gray-300 hover:border-gray-400'
    }
  }

  const getStateIcon = () => {
    switch (uploadState) {
      case 'uploading': return <Loader2 className="h-8 w-8 animate-spin text-blue-500" />
      ...
      default: return <Upload className={cn("h-8 w-8", isDragging ? "text-blue-500" : "text-gray-400")} />
    }
  }
