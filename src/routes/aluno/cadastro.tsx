...
export const Route = createFileRoute('/aluno/cadastro')({
...
function RouteComponent() {
  ...
  const [documentos] = useState([
    { id: 'termo', nome: 'Termo de compromisso assinado', status: 'pendente' as const },
    { id: 'matricula', nome: 'Comprovante de matrícula', ultimaAtualizacao: '08/2024', status: 'expirado' as const },
    { id: 'historico', nome: 'Histórico escolar', ultimaAtualizacao: '02/2025', status: 'válido' as const },
  ])
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-12 space-y-12">
      <section>
        <h1 className="text-3xl font-bold text-gray-900">Inscrição para monitoria</h1>
        <p className="text-gray-600">Preencha o formulário abaixo para se candidatar à vaga de monitoria.</p>
      </section>
