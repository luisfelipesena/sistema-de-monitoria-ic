...
CREATE TYPE "public"."tipo_assinatura_enum" AS ENUM('PROJETO_PROFESSOR_RESPONSAVEL', 'TERMO_COMPROMISSO_ALUNO', 'EDITAL_ADMIN', 'ATA_SELECAO_PROFESSOR');--> statement-breakpoint
