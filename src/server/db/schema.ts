...
export const projetoTable = pgTable('projeto', {
  ...
  observacoesAdmin: text('observacoes_admin'), // Admin observations/notes
  resultadosPublicados: boolean('resultados_publicados').default(false),
  dataPublicacaoResultados: timestamp('data_publicacao_resultados', {
    withTimezone: true,
    mode: 'date',
  }),
...
export const tipoNotificacaoEnum = pgEnum('tipo_notificacao_enum', [
...
// Add alias for professorDisciplinaTable
export const professorDisciplinaTable = disciplinaProfessorResponsavelTable;
