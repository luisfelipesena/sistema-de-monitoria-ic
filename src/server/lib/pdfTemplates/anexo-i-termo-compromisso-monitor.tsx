...
export function AnexoITermoCompromissoMonitorTemplate({ data }: { data: AnexoITermoInputs }) {
  ...
  const enderecoCompleto = [
    ...
    monitor.endereco.cep ? `CEP: ${monitor.endereco.cep}` : "",
  ]
    .filter(Boolean)
    .join(", ")
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <Text style={styles.bodyParagraph}>
          ...
          <Text style={{ fontStyle: "italic" }}>(código e nome)</Text> {projeto.disciplina.codigo} - {projeto.disciplina.nome}.........................................................., a ser desenvolvido durante o semestre{" "}
          <Text style={{ fontFamily: "Helvetica-Bold" }}>{projeto.ano}.{semestreNum}</Text>, sob a responsabilidade do(a) professor(a){" "}
          {projeto.professorResponsavelNome}..................................................., comprometo-me a:
        </Text>
        ...
        <View style={styles.footerSignatures}>
          <View style={styles.footerCellLocal}>
            <Text style={styles.lineText}>{signature?.local || "Salvador"}</Text>
            <Text style={styles.captionText}>Local</Text>
          </View>
          <View style={styles.footerCellData}>
            <Text style={styles.lineText}>{formatDateFullBR(hoje)}</Text>
            <Text style={styles.captionText}>Data</Text>
          </View>
          <View style={styles.footerCellSignature}>
            {signature?.dataUrl ? (
              <Image src={signature.dataUrl} style={styles.signatureImg} cache={false} />
            ) : null}
