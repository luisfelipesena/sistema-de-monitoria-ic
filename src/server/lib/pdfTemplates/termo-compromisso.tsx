    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.departmentName}>INSTITUTO DE COMPUTAÇÃO</Text>
          <Text style={styles.departmentName}>COORDENAÇÃO DE MONITORIA</Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.paragraph}>
            <Text style={styles.clauseNumber}>3.1.</Text> O monitor compromete-se a cumprir fielmente as atividades de
            monitoria conforme estabelecido no projeto de monitoria aprovado, sob orientação do professor responsável.
          </Text>

          <Text style={styles.paragraph}>
            <Text style={styles.clauseNumber}>3.2.</Text> O monitor deverá cumprir a carga horária de{" "}
            {projeto.cargaHorariaSemana}
          ...
          <Text style={styles.paragraph}>
            <Text style={styles.clauseNumber}>3.4.</Text> O monitor deverá elaborar e entregar relatórios periódicos de
        ...
        <View style={styles.footer}>
          <Text>Salvador, {termo.dataGeracao} | Documento gerado pelo Sistema de Monitoria IC-UFBA</Text>
        </View>
      </Page>
    </Document>
  )
