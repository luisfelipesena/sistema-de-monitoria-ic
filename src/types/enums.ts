...
export const STATUS_INSCRICAO_CONFIRMED_INTEREST = 'CONFIRMED_INTEREST' as const
...
export const CONFIRMED_INTEREST = STATUS_INSCRICAO_CONFIRMED_INTEREST
...
export const STATUS_INSCRICAO_LABELS: Record<StatusInscricao, string> = {
  ...
  CONFIRMED_INTEREST: 'Interesse Confirmado',
  ...
  WAITING_LIST: 'Aprovado - Aguardando Confirmação',
}
